...
export default function Links() {
  return (
    <Page title="友情链接">
      <p>如果你也想与我交换友链，敬请在下方留言，附上你的网站信息😉</p>
      ...
      <div className="space-y-2">
        ...
        <p><b>URL</b>：<Link href="/">https://stone-dev.top</Link></p>
        <p><b>图标</b>：<Link href="https://stone-dev.top/static/icon.png">https://stone-dev.top/static/icon.png</Link></p>
