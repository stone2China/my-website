...
import { DownloadButton } from "@/components/dev-sidecar/download-button";
...
import {
  ...
  parseAssetName,
  type GitHubRelease,
} from "@/lib/dev-sidecar/api";
import { ReleasesContext } from "@/contexts/dev-sidecar-releases";
import { HistoryVersionsDialog } from "@/components/dev-sidecar/history-versions-dialog";
import { Button } from "@/components/ui/button";
import { ArrowRight, Github, ExternalLink, Monitor, Apple, Terminal } from "lucide-react";
...
export default function DevSidecarPage() {
  ...
  return (
    <ReleasesContext.Provider value={{
      ...
      <div className="flex-1 flex flex-col items-center justify-center gap-6 px-4 pt-24 pb-16">
        {/* Logo & Title */}
